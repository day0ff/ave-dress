...
export const DRESS: Dress[] = [
  ...
  { id: 8, images: [IMAGES[7], IMAGES[6], IMAGES[8]], price: 35, size: '44-45', iformation: 'Рыбный текст' },
  { id: 9, images: [IMAGES[8], IMAGES[7], IMAGES[6]], price: 35, size: '44-45', iformation: 'Рыбный текст' }
];
